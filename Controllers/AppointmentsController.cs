...
namespace OnlineHealthManagement.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public AppointmentsController(OnlineHMContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public dynamic GetAppointment(int Id, string status)
        {
            var query = (
                from patient in _context.Patient
                from doctor in _context.Doctor
                where doctor.IsAvailable == "Yes" || doctor.Status == "Approved"
                select new
                {
